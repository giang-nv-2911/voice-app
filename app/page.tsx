      ...
      <div className="w-full max-w-md flex justify-between items-center mb-8 pt-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 mr-1">
            <button
              onClick={toggleGuide}
              className={`p-2.5 rounded-xl border transition-all ${showGuide
            ...
            <Link
              href="/report"
              className="p-2.5 bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800 text-rose-500 hover:scale-105 active:scale-95 transition-all"
          ...
          {user ? (
            ...
            <a
              ...
              className="flex items-center gap-2.5 px-4 py-2 bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-indigo-500/10 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 text-[12px] font-black hover:scale-[1.02] active:scale-[0.98] transition-all group"
            >
