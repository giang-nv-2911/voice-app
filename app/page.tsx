      ...
      <div className="w-full max-w-md flex flex-col items-center flex-1">
        {showGuide && (
          <div className="w-full max-w-sm mb-10 overflow-hidden rounded-[2rem] bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl border border-white/40 dark:border-slate-800/50 shadow-2xl shadow-indigo-200/20 dark:shadow-none animate-in fade-in zoom-in-95 slide-in-from-top-4 duration-500">
            ...
            <div className="p-4 bg-slate-50/50 dark:bg-slate-900/50 border-t border-white/40 dark:border-slate-800/50 flex items-center justify-end gap-2">
              <button
                onClick={toggleGuide}
                className="w-[42px] h-[42px] flex items-center justify-center bg-indigo-500 text-white rounded-xl shadow-md shadow-indigo-200 dark:shadow-none hover:scale-105 active:scale-95 transition-all"
              ...
              <Link
                href="/report"
                className="w-[42px] h-[42px] flex items-center justify-center bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800 text-rose-500 hover:scale-105 active:scale-95 transition-all"
                title="Báo cáo"
              >
                <ReceiptText size={18} />
              </Link>
              ...
              {!user && (
                <a
                  href={`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/login/google`}
                  className="h-[42px] flex items-center gap-2 px-3 py-2 bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 text-[11px] font-black hover:scale-[1.02] active:scale-[0.98] transition-all"
                >
                  ...
                  <span className="hidden xs:inline">Google Login</span>
                </a>
              )}
            </div>
          </div>
